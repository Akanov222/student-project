...
public class StudentOrderDaoImpl implements StudentOrderDao {
    ...
    public static final String INSERT_ORDER =
            "INSERT INTO jc_student_order(" +
                    ...
                    "h_post_index, h_street_code, h_building, h_extension," +
                    "h_apartment, h_university_id, h_student_number, w_sur_name," +
                    "w_given_name, w_patronymic, w_date_of_birth, w_passport_seria," +
                    "w_passport_number, w_passport_date, w_passport_office_id," +
