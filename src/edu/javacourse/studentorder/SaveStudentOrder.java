...
/*
        List<Street> d = new DictionaryDaoImpl().findStreets("пр");
        for(Street s : d) {
        ...
        List<RegisterOffice> rof = new DictionaryDaoImpl().findRegisterOffice("010010000000");
        for(RegisterOffice r : rof) {
...
//        StudentOrder s = buildStudentOrder(10L);
